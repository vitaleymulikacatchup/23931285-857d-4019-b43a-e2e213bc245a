...
export const metadata: Metadata = {
  ...
  description: "Discover the finest premium coffee and delicious milk shakes. Order freshly roasted coffee beans and specialty beverages online.",
  keywords: "coffee shop, espresso, mocha, latte, milkshakes, coffee delivery",
  openGraph: {
    title: "Black Coffee - Premium Coffee Shop",
    description: "Freshly roasted coffee and specialty drinks",
    url: "https://blackcoffee.com",
    siteName: "Black Coffee",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_30ordogEOn7VO6LZdIWb5atLXky/uploaded-1763546800316-mt4oze40.jpg",
        alt: "Freshly roasted premium coffee"
      }
    ],
    type: "website"
  },
